            ...
            <div class="slider-area">
                ...
                <div class="header-right2 d-flex align-items-center">
                    ...
                    <div class="header-social  d-block d-md-none">
                        <a href="https://twitter.com/musinsacom"><i class="fab fa-twitter"></i></a>
                        <a href="https://www.facebook.com/musinsa"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/musinsacom/"><i class="fab fa-pinterest-p"></i></a>
                    </div>
                    <!-- Search Box -->
                    <div class="search d-block d-md-none" >
                        <ul class="d-flex align-items-center">
                            ...
                            <li>
                                <div class="card-stor">
                                    <img src="/resources/assets/img/gallery/card.svg" alt="">
                                    <span>0</span>
                                </div>
                            </li>
                        </ul>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-8 col-lg-9">
                                    ...
                                    <div class="hero__caption">
                                        <h1>fashion<br>is<br>fair</h1>
                                        <a href="/product/shop" class="btn">인기 품목</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-xl-8 col-lg-9">
                                    ...
                                    <div class="hero__caption">
                                        <h1>fashion<br>is<br>fair</h1>
                                        <a href="/product/shop" class="btn">인기품목</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="popular-items pt-50">
            <div class="container-fluid">
                        ...
                        <div class="single-popular-items mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                            <div class="popular-img">
                                ...
                                <div class="favorit-items">
                                 <a href="/product/shop" class="btn">구매하러 가기 </a>
                             </div>
                         </div>
                     </div>
                 </div>
             ...
             <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-popular-items mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                    <div class="popular-img">
                        <img src="/resources/assets/img/gallery/popular3.png" alt="">
                        <div class="img-cap">
                            <span>Jackets</span>
                        </div>
                        <div class="favorit-items">
         ...
         <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="single-popular-items mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                <div class="popular-img">
                    <img src="/resources/assets/img/gallery/popular4.png" alt="">
                    <div class="img-cap">
                        <span>Clothes</span>
                    </div>
                    <div class="favorit-items">
...
<div class="new-arrival">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                    <div class="popular-img">
                        <img src="/resources/assets/img/gallery/arrival1.png" alt="">
                        <div class="favorit-items">
                            <!-- <span class="flaticon-heart"></span> -->
                            <img src="/resources/assets/img/gallery/favorit-card.png" alt="">
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                    <div class="popular-img">
                        <img src="/resources/assets/img/gallery/arrival2.png" alt="">
                        <div class="favorit-items">
                            <!-- <span class="flaticon-heart"></span> -->
                            <img src="/resources/assets/img/gallery/favorit-card.png" alt="">
                        </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
            <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                <div class="popular-img">
                    <img src="/resources/assets/img/gallery/arrival3.png" alt="">
                    <div class="favorit-items">
                        <!-- <span class="flaticon-heart"></span> -->
                        <img src="/resources/assets/img/gallery/favorit-card.png" alt="">
                    </div>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
        <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
            <div class="popular-img">
                <img src="/resources/assets/img/gallery/arrival4.png" alt="">
                <div class="favorit-items">
                    <!-- <span class="flaticon-heart"></span> -->
                    <img src="/resources/assets/img/gallery/favorit-card.png" alt="">
                </div>
...
<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
    <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
        <div class="popular-img">
            <img src="/resources/assets/img/gallery/arrival5.png" alt="">
            <div class="favorit-items">
                <!-- <span class="flaticon-heart"></span> -->
                <img src="/resources/assets/img/gallery/favorit-card.png" alt="">
            </div>
...
<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
    <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
        <div class="popular-img">
            <img src="/resources/assets/img/gallery/arrival6.png" alt="">
            <div class="favorit-items">
                <!-- <span class="flaticon-heart"></span> -->
                <img src="/resources/assets/img/gallery/favorit-card.png" alt="">
            </div>
...
<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
    <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
        <div class="popular-img">
            <img src="/resources/assets/img/gallery/arrival7.png" alt="">
            <div class="favorit-items">
                <!-- <span class="flaticon-heart"></span> -->
                <img src="/resources/assets/img/gallery/favorit-card.png" alt="">
            </div>
...
<div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
    <div class="single-new-arrival mb-50 text-center wow fadeInUp" data-wow-duration="1s" data-wow-delay=".8s">
        <div class="popular-img">
            <img src="/resources/assets/img/gallery/arrival8.png" alt="">
            <div class="favorit-items">
                <!-- <span class="flaticon-heart"></span> -->
                <img src="/resources/assets/img/gallery/favorit-card.png" alt="">
            </div>
...
<div class="row justify-content-center">
    <div class="room-btn">
        <a href="/shop" class="border-btn">더 보기</a>
    </div>
</div>
</div>
</div>
<!--? New Arrival End -->
<!--? collection -->
<section class="collection section-bg2 section-padding30 section-over1 ml-15 mr-15" data-background="/resources/assets/img/gallery/section_bg01.png">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="single-product mb-50">
                    <div class="location-img">
                        <img src="/resources/assets/img/gallery/popular-imtes1.png" alt="">
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="single-product mb-50">
                    <div class="location-img">
                        <img src="/resources/assets/img/gallery/popular-imtes2.png" alt="">
                    </div>
                    <div class="location-details">
                        <p><a href="product_details.html">Established fact that by the<br> readable content</a></p>
                        <a href="product_details.html" class="btn">Read More</a>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-cat wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                    <div class="cat-icon">
                        <img src="/resources/assets/img/icon/services4.svg" alt="">
                    </div>
                    <div class="cat-cap">
                        <h5>Fast & Free Delivery</h5>
                        <p>Free delivery on all orders</p>
